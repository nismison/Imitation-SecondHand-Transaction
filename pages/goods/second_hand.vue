	...
	<view>
		...
		<view class="bg-white padding zaiui-goods-synopsis-view">
			<view class="user-view">
				...
				<view class="text-black text-name">Furuto11</view>
				...
				<view class="cu-item">
					...
					<view class="content">
						<view class="text-black">
							<view class="text-cut">Furuto</view>
			...
			<view class="zaiui-interaction-view" v-else>
				...
				<view class="zaiui-interaction-list-view">
					<view class="list-itme">
						...
						<view class="view-box">
							<view class="title-box">
								<text class="margin-right-xs">Furuto</text>
							...
							<view class="padding-sm radius zaiui-comment-view">
								...
								<view class="zaiui-reply-view">
									...
									<text class="text-blue">@Furuto</text>
					...
					<view class="list-itme">
						...
						<view class="view-box">
							<view class="title-box">
								<text class="margin-right-xs">Furuto33</text>
					...
					<view class="list-itme">
						...
						<view class="view-box">
							<view class="title-box">
								<text class="margin-right-xs">Furuto444</text>
